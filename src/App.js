...
const App = () => {
  return (
    <div className="Tbestdev">
      {/* Nav design start */}
    <nav className="bg-gray-200 border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800">
  <div className="container flex flex-wrap justify-between items-center mx-auto">
  <a href="/" className="flex items-center">
      <img src="./images/fuu1.jpg" className="mr-3 w-9 sm:h-9 rounded-full" alt="Site Logo" />
      <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Tbestdev</span>
  </a>
...
<div className="gd mt-10 gap-4 sm:grid sm:grid-cols-2">
  ...
  <div className="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
      ...
      <div className="p-5">
          <a href="/">
              <h5 className="ft mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Noteworthy technology acquisitions 2021</h5>
          </a>
...
<div className="gd mt-10 gap-4 sm:grid sm:grid-cols-2">
  ...
  <div className="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
    <a href="/">
      <img className="rounded-t-lg" src="./images/laptop.jpg" alt="" />
    </a>
    <div className="p-5">
        <a href="/">
            <h5 className=" ft mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Noteworthy technology acquisitions 2021</h5>
  ...
  <div className="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
    <a href="/">
      <img className="rounded-t-lg h-60 w-full" src="./images/glasses.jpg" alt="" />
    </a>
    <div className="p-5">
        <a href="/">
            <h5 className=" ft mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Noteworthy technology acquisitions 2021</h5>
  ...
  <div className="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
    <a href="/">
      <img className="rounded-t-lg" src="./images/microscope.jpg" alt="" />
    </a>
    <div className="p-5">
        <a href="/">
            <h5 className=" ft mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Noteworthy technology acquisitions 2021</h5>
  ...
  <div className="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
    <a href="/">
      <img className="rounded-t-lg" src="./images/brand.jpg" alt="" />
    </a>
    <div className="p-5">
        <a href="/">
            <h5 className=" ft mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Noteworthy technology acquisitions 2021</h5>
...
<footer className="p-4 bg-white sm:p-6 dark:bg-gray-800">
    <div className="md:flex md:justify-between">
        <div className="mb-6 md:mb-0">
            <a href="https://Tbestdev" className="flex items-center">
                <img src="./images/fuu1.jpg" className="mr-3 w-9 sm:h-9 rounded-full" alt="Tbestdev" />
                <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Tbestdev</span>
            </a>
        </div>
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
                ...
                <ul className="text-gray-600 dark:text-gray-400">
                    <li className="mb-4">
                        <a href="https://Tbestdev" className="hover:underline">Tbestdev</a>
                    </li>
                    <li>
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://Tbestdev" className="hover:underline">Tbestdev™</a>. All Rights Reserved.
        </span>
